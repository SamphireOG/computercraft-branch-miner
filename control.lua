...
local function switchProject(projectName)
    ...
    if projectConfig.startY then
        ...
        -- IMPORTANT: Since we don't have GPS, the turtle is physically placed at START_Y
        -- Update HOME_Y to match so navigation works correctly
...
local function createNewProject()
    ...
    term.setTextColor(colors.white)
    term.setCursorPos(2, 7)
    print("Tunnel length [64]: (Q=cancel)")
    term.setBackgroundColor(colors.gray)
    term.setTextColor(colors.white)
    ...
    -- Tunnel size selection (compact)
    term.setCursorPos(2, 16)
    term.setBackgroundColor(colors.black)
    term.setTextColor(colors.white)
    term.write("Size: ")
    term.setTextColor(colors.yellow)
    print("1)2x1 2)2x2 3)3x3 [2]")
    term.setBackgroundColor(colors.gray)
    term.setTextColor(colors.white)
    ...
    -- Wall protection option (compact)
    term.setCursorPos(2, 18)
    term.setBackgroundColor(colors.black)
    term.setTextColor(colors.white)
    term.write("Wall protect: ")
    term.setTextColor(colors.yellow)
    print("Y)Yes N)No [Y]")
    term.setBackgroundColor(colors.gray)
    term.setTextColor(colors.white)
